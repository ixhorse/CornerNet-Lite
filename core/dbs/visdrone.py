...
class VisDrone(DETECTION):
    def __init__(self, db_config, split=None, sys_config=None):
        ...
        if split is not None:
            coco_dir = os.path.join(sys_config.data_dir, "detect_coco")
